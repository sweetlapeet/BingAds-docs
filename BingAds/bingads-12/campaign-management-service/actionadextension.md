...
|<a name="finalmobileurls"></a>FinalMobileUrls|This is a mobile-friendly landing page URL when Action Extensions are served on mobile devices.<br/><br/>**Add:** Optional<br/>**Update:** Optional. If no value is specified on update, this Bing Ads setting is not changed.|**string** array|
|<a name="finalurls"></a>FinalUrls|This is the link to your specific web page or form that corresponds to the action text.<br/><br/>When an action URL isn't provided, the ad's final URL will be used.<br/><br/>Although the data type is a list of strings, only the first list item is used by Bing Ads.<br/><br/>**Add:** Optional<br/>**Update:** Optional. If no value is specified on update, this Bing Ads setting is not changed.|**string** array|
